...
class NetBT2(nn.Module):
    def __init__(self, n_class=10):
        ...
        self.Gau1 = T.GaussianBlur(kernel_size=3,sigma=(0.5, 0.5))
        self.Gau2 = T.GaussianBlur(kernel_size=3,sigma=(0.7, 0.7))
        self.Gau3 = T.GaussianBlur(kernel_size=3,sigma=(0.9, 0.9))
        self.Gau4 = T.GaussianBlur(kernel_size=3,sigma=(1.1, 1.1))
        self.Gau5 = T.GaussianBlur(kernel_size=3,sigma=(1.3, 1.3))
        self.Gau6 = T.GaussianBlur(kernel_size=3,sigma=(1.5, 1.5))
    ...
    def forward(self, x):
        ...
        x_Gau1 = self.Gau1(x_gray)
        x_Gau2 = self.Gau2(x_gray)
        x_Gau3 = self.Gau3(x_gray)
        x_Gau4 = self.Gau4(x_gray)
        x_Gau5 = self.Gau5(x_gray)
        x_Gau6 = self.Gau6(x_gray)
